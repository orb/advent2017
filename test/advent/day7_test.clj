(ns advent.day7-test
  (:require [advent.day7 :refer :all]
            [clojure.test :refer :all]))

;; the input here can still be neatly represented by quoted structures, but I think
;; should use this as a chance to try out something like instaparse
(def my-input
  '[[bxlur (38)]
    [vgeifn (90)]
...
(deftest test-part1
  (is (= 'tknk  (part1 example-input)))
  (is (= 'mkxke (part1 my-input))))


(deftest test-part2
  (is (= 60 (part2 example-input)))
  (is (= 268 (part2 my-input))))
